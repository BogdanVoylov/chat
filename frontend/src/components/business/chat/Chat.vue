<template>
  <div :class="$style.container">
    ...
    <div :class="$style.bodyWrapper">
      <div :class="$style.body">
        <div
          ...
          :class="{
            [$style.message]: true,
            [$style.right]: message.recipient != self
          }"
        >
          <Message
            :author="message.author"
            :text="message.text"
            :left="message.recipient != self"
    ...
    <div :class="$style.input">
      <TextInput placeholder="Start chatting!" v-model="input" />
...
export default {
  ...
  mounted() {
    ...
    this.socket.on('connect', () => {
      ...
      this.socket.emit('identity', 5, response =>
